...
public class LobbyActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        app.client.registerPacketHandler(this::onStart, PacketGameStateChanged.class, this);
    }
    ...
    public void onStart(PacketGameStateChanged packet, SpeedQuestClient client) {
